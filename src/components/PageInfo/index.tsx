    ...
    return (
        <div className="pageInfo-wrapper">
            <div className="pageInfo-box">
                <div className="pageInfo-texts">
                    <span className="pageInfo-Header">{name}</span>
                    <span className="pageInfo-Text">{text}</span>
                    <button className={"pageInfo-btn"}>ԿԱՐԴԱԼ ԱՎԵԼԻՆ</button>
                </div>
                <div className={"img-wrapper"}>
                    <img className={"img"} src={img} alt="photos"/>
                    <svg width="345" height="366" viewBox="0 0 345 366" fill="none" xmlns="http://www.w3.org/2000/svg">
